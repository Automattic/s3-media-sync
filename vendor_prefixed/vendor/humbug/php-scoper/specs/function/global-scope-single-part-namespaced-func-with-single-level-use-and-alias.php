...
PHP
, 'Whitelisted namespaced function call imported with a partial use statement in the global scope' => ['whitelist' => ['WPCOM_VIP\\Foo\\main'], 'registered-functions' => [['WPCOM_VIP\\Foo\\main', 'WPCOM_VIP\\Humbug\\Foo\\main']], 'payload' => <<<'PHP'
<?php
