...
], 'Different kind of whitelisted class constant calls in the global scope' => ['whitelist' => ['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Foo\\Bar\\Poz'], 'registered-classes' => [['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\Foo\\Bar'], ['WPCOM_VIP\\Foo\\Bar\\Poz', 'WPCOM_VIP\\Humbug\\Foo\\Bar\\Poz']], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Different kind of class constant calls in a namespace' => ['whitelist' => ['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Foo\\Bar\\Poz', 'WPCOM_VIP\\A\\Foo', 'WPCOM_VIP\\A\\Foo\\Bar', 'WPCOM_VIP\\A\\Foo\\Bar\\Poz', 'WPCOM_VIP\\A\\Aoo', 'WPCOM_VIP\\A\\Aoo\\Aoz', 'WPCOM_VIP\\A\\Aoz', 'WPCOM_VIP\\A\\Aoo\\Aoz\\Poz'], 'registered-classes' => [['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\Foo\\Bar'], ['WPCOM_VIP\\Foo\\Bar\\Poz', 'WPCOM_VIP\\Humbug\\Foo\\Bar\\Poz'], ['WPCOM_VIP\\A\\Foo', 'WPCOM_VIP\\Humbug\\A\\Foo'], ['WPCOM_VIP\\A\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\A\\Foo\\Bar'], ['WPCOM_VIP\\A\\Foo\\Bar\\Poz', 'WPCOM_VIP\\Humbug\\A\\Foo\\Bar\\Poz'], ['WPCOM_VIP\\A\\Aoo', 'WPCOM_VIP\\Humbug\\A\\Aoo'], ['WPCOM_VIP\\A\\Aoo\\Aoz', 'WPCOM_VIP\\Humbug\\A\\Aoo\\Aoz'], ['WPCOM_VIP\\A\\Aoo\\Aoz\\Poz', 'WPCOM_VIP\\Humbug\\A\\Aoo\\Aoz\\Poz']], 'payload' => <<<'PHP'
<?php
