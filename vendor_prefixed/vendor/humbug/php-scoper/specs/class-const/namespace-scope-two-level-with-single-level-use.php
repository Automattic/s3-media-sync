...
PHP
], 'FQ Constant call on a whitelisted namespaced class partially imported with a use statement' => ['whitelist' => ['WPCOM_VIP\\Foo\\Bar'], 'registered-classes' => [['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on a whitelisted namespaced class imported with a use statement' => ['whitelist' => ['WPCOM_VIP\\Foo\\Bar'], 'registered-classes' => [['WPCOM_VIP\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
