...
PHP
, 'Static method call statement of a whitelisted class' => ['whitelist' => ['WPCOM_VIP\\X\\Foo\\Bar'], 'registered-classes' => [['WPCOM_VIP\\X\\Foo\\Bar', 'WPCOM_VIP\\Humbug\\X\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ static method call statement of a non-whitelisted class' => ['whitelist' => ['WPCOM_VIP\\X\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
