...
PHP
, 'Catch a whitelisted custom exception class' => ['whitelist' => ['FooException'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Catch a custom exception class which belongs to the whitelisted root namespace' => ['whitelist' => ['\\*'], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Catch a whitelisted custom exception class in a namespace' => ['whitelist' => ['WPCOM_VIP\\Acme\\FooException'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Catch a custom exception class in a whitelisted namespace' => ['whitelist' => ['Acme\\*'], 'payload' => <<<'PHP'
<?php
