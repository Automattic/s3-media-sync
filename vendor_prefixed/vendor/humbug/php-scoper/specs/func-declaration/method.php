...
], 'Method declarations' => ['whitelist' => ['WPCOM_VIP\\X\\Y', 'BAR_CONST'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Method declarations with return types' => ['whitelist' => ['WPCOM_VIP\\X\\Y'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
