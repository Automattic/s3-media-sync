...
PHP
, 'Simple whitelisted function' => ['whitelist' => ['WPCOM_VIP\\Acme\\foo'], 'registered-functions' => [['WPCOM_VIP\\Acme\\foo', 'WPCOM_VIP\\Humbug\\Acme\\foo']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Function declaration in a namespace' => ['whitelist' => ['WPCOM_VIP\\X\\Y'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Function declaration in a namespace with whitelisted classes' => ['whitelist' => ['WPCOM_VIP\\X\\Y'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Function declaration in a namespace with use statements' => ['whitelist' => ['WPCOM_VIP\\X\\Y'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Function declaration in a whitelisted namespace' => ['whitelist' => ['Pi\\*'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Function declarations with return types in a namespace with use statements' => ['whitelist' => ['WPCOM_VIP\\X\\Y'], 'registered-classes' => [['WPCOM_VIP\\X\\Y', 'WPCOM_VIP\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
