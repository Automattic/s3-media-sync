...
PHP
, 'Whitelisted constant call in a namespace' => ['whitelist' => ['DUMMY_CONST'], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Whitelisted FQ constant call in a namespace' => ['whitelist' => ['DUMMY_CONST'], 'payload' => <<<'PHP'
<?php
