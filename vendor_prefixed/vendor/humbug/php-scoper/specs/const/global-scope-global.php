...
PHP
, 'Whitelisted constant call in the global namespace' => ['whitelist' => ['DUMMY_CONST'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Constant call in the global namespace which is whitelisted' => ['whitelist' => ['\\*'], 'payload' => <<<'PHP'
<?php
