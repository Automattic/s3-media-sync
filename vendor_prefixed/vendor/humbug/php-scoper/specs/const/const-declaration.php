...
], 'Constants declaration in the global namespace' => ['payload' => <<<'PHP'
<?php
...
PHP
], 'Constant declarations in the global namespace which is whitelisted' => ['whitelist' => ['*'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Whitelisted constant declarations in the global namespace' => ['whitelist' => ['FOO_CONST', 'BAR_CONST', 'WPCOM_VIP\\Acme\\BAR_CONST', 'BAZ*', 'Emca\\BAZ*'], 'payload' => <<<'PHP'
<?php
...
PHP
,
], 'Constants declaration in a namespace' => ['payload' => <<<'PHP'
<?php
...
PHP
], 'Constants declaration in a whitelisted namespace' => ['whitelist' => ['Acme\\*'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Whitelisted constants declaration in a namespace' => ['whitelist' => ['WPCOM_VIP\\Acme\\BAR_CONST'], 'payload' => <<<'PHP'
<?php
