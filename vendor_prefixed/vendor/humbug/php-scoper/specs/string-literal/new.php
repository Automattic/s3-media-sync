...
PHP
, 'FQCN string argument on whitelisted class' => ['whitelist' => ['WPCOM_VIP\\Symfony\\Component\\Yaml\\Yaml'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQCN string argument on classes belonging to a whitelisted namespace' => ['whitelist' => ['Symfony\\Component\\*'], 'payload' => <<<'PHP'
<?php
