...
PHP
, 'Declaration in the global namespace with global classes whitelisted' => ['whitelist-global-classes' => \true, 'registered-classes' => [['A', 'WPCOM_VIP\\Humbug\\A'], ['B', 'WPCOM_VIP\\Humbug\\B'], ['C', 'WPCOM_VIP\\Humbug\\C']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Declaration in the global namespace which is whitelisted' => ['whitelist' => ['\\*'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Declaration in the global namespace with some whitelisted classes' => ['whitelist' => ['A', 'C'], 'registered-classes' => [['A', 'WPCOM_VIP\\Humbug\\A'], ['C', 'WPCOM_VIP\\Humbug\\C']], 'payload' => <<<'PHP'
<?php
