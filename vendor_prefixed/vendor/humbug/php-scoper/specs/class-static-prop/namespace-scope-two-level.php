...
PHP
, 'Constant call on a whitelisted namespaced class' => ['whitelist' => ['WPCOM_VIP\\X\\PHPUnit\\Command'], 'registered-classes' => [['WPCOM_VIP\\X\\PHPUnit\\Command', 'WPCOM_VIP\\Humbug\\X\\PHPUnit\\Command']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on a whitelisted namespaced class' => ['whitelist' => ['WPCOM_VIP\\PHPUnit\\Command'], 'registered-classes' => [['WPCOM_VIP\\PHPUnit\\Command', 'WPCOM_VIP\\Humbug\\PHPUnit\\Command']], 'payload' => <<<'PHP'
<?php
