...
final class NameFactory
{
     ...
     */
    public static function concat($name1, $name2, array $attributes = []) : \WPCOM_VIP\PhpParser\Node\Name
    {
        if (null === $name1 && null === $name2) {
            throw new \InvalidArgumentException('Expected one of the names to not be null');
        }
        /** @var Name $fqName */
        $fqName = \WPCOM_VIP\PhpParser\Node\Name::concat($name1, $name2, $attributes);
        return $fqName;
    }
