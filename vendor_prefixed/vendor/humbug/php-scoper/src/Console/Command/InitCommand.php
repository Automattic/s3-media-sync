...
final class InitCommand extends \WPCOM_VIP\Humbug\PhpScoper\Console\Command\BaseCommand
{
    ...
    public function __construct($name = null)
    {
        ...
        $this->fileSystem = new \WPCOM_VIP\Symfony\Component\Filesystem\Filesystem();
    }
    /**
     * @inheritdoc
     */
    ...
    {
        parent::configure();
        $this->setName('init')->setDescription('Generates a configuration file.')->addOption(self::CONFIG_FILE_OPT, 'c', \WPCOM_VIP\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, \sprintf('Configuration file. Will use "%s" if found by default.', self::CONFIG_FILE_DEFAULT), null);
    }
    /**
     * @inheritdoc
     */
    protected function execute(\WPCOM_VIP\Symfony\Component\Console\Input\InputInterface $input, \WPCOM_VIP\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $io->writeln($formatter->formatSection('PHP-Scoper configuration generate', 'Welcome!'));
    ...
    private function retrieveConfig(\WPCOM_VIP\Symfony\Component\Console\Input\InputInterface $input, \WPCOM_VIP\Symfony\Component\Console\Style\OutputStyle $io) : ?string
    {
