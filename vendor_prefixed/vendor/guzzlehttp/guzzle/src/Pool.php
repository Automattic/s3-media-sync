...
class Pool implements \WPCOM_VIP\GuzzleHttp\Promise\PromisorInterface
{
     ...
     */
    public function __construct(\WPCOM_VIP\GuzzleHttp\ClientInterface $client, $requests, array $config = [])
    {
        ...
        $this->each = new \WPCOM_VIP\GuzzleHttp\Promise\EachPromise($requests(), $config);
    }
    /**
     * Get promise
     */
    public function promise() : \WPCOM_VIP\GuzzleHttp\Promise\PromiseInterface
    {
     ...
     */
    public static function batch(\WPCOM_VIP\GuzzleHttp\ClientInterface $client, $requests, array $options = []) : array
    {
        $res = [];
