...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
...
{
    \WPCOM_VIP\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \WPCOM_VIP\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
