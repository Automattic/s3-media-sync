 ...
 */
class FnStream implements \WPCOM_VIP\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WPCOM_VIP\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
