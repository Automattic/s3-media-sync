...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WPCOM_VIP\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WPCOM_VIP\Psr\Http\Message\StreamInterface $stream)
    {
