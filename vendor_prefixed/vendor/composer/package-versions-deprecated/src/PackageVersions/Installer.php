...
use WPCOM_VIP\Composer\Config;
use WPCOM_VIP\Composer\EventDispatcher\EventSubscriberInterface;
use WPCOM_VIP\Composer\IO\IOInterface;
use WPCOM_VIP\Composer\Package\AliasPackage;
use WPCOM_VIP\Composer\Package\Locker;
use WPCOM_VIP\Composer\Package\PackageInterface;
use WPCOM_VIP\Composer\Package\RootPackageInterface;
use WPCOM_VIP\Composer\Plugin\PluginInterface;
use WPCOM_VIP\Composer\Script\Event;
use WPCOM_VIP\Composer\Script\ScriptEvents;
use Generator;
...
final class Installer implements \WPCOM_VIP\Composer\Plugin\PluginInterface, \WPCOM_VIP\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    ...
    {
        return [\WPCOM_VIP\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\WPCOM_VIP\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \WPCOM_VIP\Composer\Composer $composer, \WPCOM_VIP\Composer\IO\IOInterface $io)
    {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\WPCOM_VIP\Composer\Config $composerConfig, \WPCOM_VIP\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\WPCOM_VIP\Composer\Package\RootPackageInterface $rootPackage) : \WPCOM_VIP\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \WPCOM_VIP\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\WPCOM_VIP\Composer\Package\Locker $locker, \WPCOM_VIP\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
