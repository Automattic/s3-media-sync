...
use WPCOM_VIP\Aws\CloudTrail\Exception\CloudTrailException;
/**
...
class LogFileIterator extends \IteratorIterator
{
    ...
    public static function forTrail(\WPCOM_VIP\Aws\S3\S3Client $s3Client, \WPCOM_VIP\Aws\CloudTrail\CloudTrailClient $cloudTrailClient, array $options = [])
    {
        ...
        } catch (\WPCOM_VIP\Aws\CloudTrail\Exception\CloudTrailException $e) {
     ...
     * @param array    $options
     */
    public function __construct(\WPCOM_VIP\Aws\S3\S3Client $s3Client, $s3BucketName, array $options = [])
    {
