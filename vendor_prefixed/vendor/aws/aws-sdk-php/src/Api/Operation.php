 ...
 */
class Operation extends \WPCOM_VIP\Aws\Api\AbstractModel
{
    private $input;
    private $output;
    private $errors;
    ...
    public function getInput()
    {
        if (!$this->input) {
            if ($input = $this['input']) {
                ...
                $this->input = new \WPCOM_VIP\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->input;
    }
    ...
    public function getOutput()
    {
        if (!$this->output) {
            if ($output = $this['output']) {
                ...
                $this->output = new \WPCOM_VIP\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->output;
    }
