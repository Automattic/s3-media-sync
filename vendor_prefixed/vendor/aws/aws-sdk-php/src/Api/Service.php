...
use WPCOM_VIP\Aws\Api\Serializer\QuerySerializer;
use WPCOM_VIP\Aws\Api\Serializer\Ec2ParamBuilder;
use WPCOM_VIP\Aws\Api\Parser\QueryParser;
/**
 * Represents a web service API model.
 */
class Service extends \WPCOM_VIP\Aws\Api\AbstractModel
{
    /** @var callable */
    private $apiProvider;
    /** @var string */
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        parent::__construct($definition, new \WPCOM_VIP\Aws\Api\ShapeMap($definition['shapes']));
     ...
     */
    public static function createSerializer(\WPCOM_VIP\Aws\Api\Service $api, $endpoint)
    {
        static $mapping = ['json' => 'WPCOM_VIP\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'WPCOM_VIP\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'WPCOM_VIP\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'WPCOM_VIP\\Aws\\Api\\Serializer\\RestXmlSerializer'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api, $endpoint);
        }
        if ($proto == 'ec2') {
            return new \WPCOM_VIP\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \WPCOM_VIP\Aws\Api\Serializer\Ec2ParamBuilder());
        }
     ...
     * @throws \UnexpectedValueException
     */
    public static function createErrorParser($protocol, \WPCOM_VIP\Aws\Api\Service $api = null)
    {
        static $mapping = ['json' => 'WPCOM_VIP\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'WPCOM_VIP\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'WPCOM_VIP\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'WPCOM_VIP\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'WPCOM_VIP\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
     ...
     * @throws \UnexpectedValueException
     */
    public static function createParser(\WPCOM_VIP\Aws\Api\Service $api)
    {
        static $mapping = ['json' => 'WPCOM_VIP\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'WPCOM_VIP\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'WPCOM_VIP\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'WPCOM_VIP\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api);
        }
        if ($proto == 'ec2') {
            return new \WPCOM_VIP\Aws\Api\Parser\QueryParser($api, null, \false);
        }
        throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
    }
    /**
    ...
    public function getOperation($name)
    {
        if (!isset($this->operations[$name])) {
            ...
            $this->operations[$name] = new \WPCOM_VIP\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
        }
    ...
    public function getErrorShapes()
    {
        ...
        foreach ($this->definition['shapes'] as $name => $definition) {
            if (!empty($definition['exception'])) {
                ...
                $result[] = new \WPCOM_VIP\Aws\Api\StructureShape($definition, $this->getShapeMap());
            }
        }
        return $result;
    }
