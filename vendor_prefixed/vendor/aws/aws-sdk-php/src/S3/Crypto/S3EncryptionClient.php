...
use WPCOM_VIP\Aws\Crypto\DecryptionTrait;
use WPCOM_VIP\Aws\HashingStream;
use WPCOM_VIP\Aws\PhpHash;
use WPCOM_VIP\Aws\Crypto\AbstractCryptoClient;
use WPCOM_VIP\Aws\Crypto\EncryptionTrait;
 ...
 * @deprecated
 */
class S3EncryptionClient extends \WPCOM_VIP\Aws\Crypto\AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \WPCOM_VIP\GuzzleHttp\Promise\promise_for($this->encrypt(\WPCOM_VIP\GuzzleHttp\Psr7\stream_for($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
