 ...
 */
class InstructionFileMetadataStrategy implements \WPCOM_VIP\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\WPCOM_VIP\Aws\S3\S3Client $client, $suffix = null)
    {
     ...
     */
    public function save(\WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope, array $args)
    {
    ...
    public function load(array $args)
    {
        ...
        $constantValues = \WPCOM_VIP\Aws\Crypto\MetadataEnvelope::getConstantValues();
