...
class S3MultipartUploadException extends \WPCOM_VIP\Aws\Exception\MultipartUploadException
{
     ...
     */
    private function collectPathInfo(\WPCOM_VIP\Aws\CommandInterface $cmd)
    {
