...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\WPCOM_VIP\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\WPCOM_VIP\Aws\Credentials\CredentialsInterface $creds)
    {
