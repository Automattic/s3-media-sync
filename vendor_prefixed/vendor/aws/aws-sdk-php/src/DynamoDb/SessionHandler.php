...
class SessionHandler implements \SessionHandlerInterface
{
     ...
     */
    public static function fromClient(\WPCOM_VIP\Aws\DynamoDb\DynamoDbClient $client, array $config = [])
    {
        $config += ['locking' => \false];
        if ($config['locking']) {
            $connection = new \WPCOM_VIP\Aws\DynamoDb\LockingSessionConnection($client, $config);
        } else {
            $connection = new \WPCOM_VIP\Aws\DynamoDb\StandardSessionConnection($client, $config);
        }
     ...
     */
    public function __construct(\WPCOM_VIP\Aws\DynamoDb\SessionConnectionInterface $connection)
    {
