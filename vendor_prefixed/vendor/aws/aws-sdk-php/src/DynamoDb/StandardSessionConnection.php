 ...
 */
class StandardSessionConnection implements \WPCOM_VIP\Aws\DynamoDb\SessionConnectionInterface
{
    ...
    public function deleteExpired()
    {
        ...
        $batch = new \WPCOM_VIP\Aws\DynamoDb\WriteRequestBatch($this->client, $this->getBatchConfig());
