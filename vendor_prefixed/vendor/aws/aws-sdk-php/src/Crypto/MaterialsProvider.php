...
abstract class MaterialsProvider implements \WPCOM_VIP\Aws\Crypto\MaterialsProviderInterface
{
     ...
     * @internal
     */
    public abstract function fromDecryptionEnvelope(\WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope);
    /**
