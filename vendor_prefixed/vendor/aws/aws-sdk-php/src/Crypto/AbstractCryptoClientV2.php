...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\WPCOM_VIP\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\WPCOM_VIP\GuzzleHttp\Psr7\Stream $plaintext, array $options, \WPCOM_VIP\Aws\Crypto\MaterialsProviderV2 $provider, \WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \WPCOM_VIP\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
