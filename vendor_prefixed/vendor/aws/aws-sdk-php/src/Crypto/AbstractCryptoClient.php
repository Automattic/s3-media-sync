...
use WPCOM_VIP\Aws\Crypto\Cipher\CipherMethod;
use WPCOM_VIP\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
    ...
    public static $supportedKeyWraps = [\WPCOM_VIP\Aws\Crypto\KmsMaterialsProvider::WRAP_ALGORITHM_NAME];
    /**
     ...
     * @internal
     */
    public abstract function encrypt(\WPCOM_VIP\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \WPCOM_VIP\Aws\Crypto\MaterialsProvider $provider, \WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \WPCOM_VIP\Aws\Crypto\MaterialsProviderInterface $provider, \WPCOM_VIP\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
