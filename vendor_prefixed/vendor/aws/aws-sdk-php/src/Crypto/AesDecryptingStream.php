 ...
 */
class AesDecryptingStream implements \WPCOM_VIP\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\WPCOM_VIP\Psr\Http\Message\StreamInterface $cipherText, $key, \WPCOM_VIP\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
