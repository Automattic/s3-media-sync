 ...
 */
class CloudFrontClient extends \WPCOM_VIP\Aws\AwsClient
{
    /**
    ...
    public function getSignedUrl(array $options)
    {
        ...
        $urlSigner = new \WPCOM_VIP\Aws\CloudFront\UrlSigner($options['key_pair_id'], $options['private_key']);
    ...
    public function getSignedCookie(array $options)
    {
        ...
        $cookieSigner = new \WPCOM_VIP\Aws\CloudFront\CookieSigner($options['key_pair_id'], $options['private_key']);
