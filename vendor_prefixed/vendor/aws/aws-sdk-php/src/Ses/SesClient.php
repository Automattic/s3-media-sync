 ...
 */
class SesClient extends \WPCOM_VIP\Aws\AwsClient
{
    /**
     ...
     * @return string
     */
    public static function generateSmtpPassword(\WPCOM_VIP\Aws\Credentials\CredentialsInterface $creds)
    {
        static $version = "\2";
        static $algo = 'sha256';
