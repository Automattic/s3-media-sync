...
use WPCOM_VIP\JmesPath\Env as JmesPath;
use WPCOM_VIP\Psr\Http\Message\ResponseInterface;
use WPCOM_VIP\Psr\Http\Message\RequestInterface;
/**
 * Represents an AWS exception that is thrown when a command fails.
 */
class AwsException extends \RuntimeException implements \WPCOM_VIP\Aws\MonitoringEventsInterface, \WPCOM_VIP\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \WPCOM_VIP\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
    ...
    {
        return \WPCOM_VIP\JmesPath\Env::search($expression, $this->toArray());
    }
}
