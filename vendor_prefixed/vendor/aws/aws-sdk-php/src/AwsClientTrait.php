...
trait AwsClientTrait
{
    public function getPaginator($name, array $args = [])
    {
        ...
        return new \WPCOM_VIP\Aws\ResultPaginator($this, $name, $args, $config);
    }
    ...
    public function getWaiter($name, array $args = [])
    {
        ...
        return new \WPCOM_VIP\Aws\Waiter($this, $name, $args, $config);
    }
    public function execute(\WPCOM_VIP\Aws\CommandInterface $command)
    {
        return $this->executeAsync($command)->wait();
    }
    public function executeAsync(\WPCOM_VIP\Aws\CommandInterface $command)
    {
