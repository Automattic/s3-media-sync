...
namespace WPCOM_VIP\Aws\Lambda;
 ...
 */
class LambdaClient extends \WPCOM_VIP\Aws\AwsClient
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \WPCOM_VIP\Aws\Middleware::mapCommand(function (\WPCOM_VIP\Aws\CommandInterface $cmd) {
