...
use WPCOM_VIP\PhpParser\Node\FunctionLike;
class ClassMethod extends \WPCOM_VIP\PhpParser\Node\Stmt implements \WPCOM_VIP\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \WPCOM_VIP\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
