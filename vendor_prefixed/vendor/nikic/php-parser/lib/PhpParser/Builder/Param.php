...
class Param implements \WPCOM_VIP\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \WPCOM_VIP\PhpParser\Node\Param(new \WPCOM_VIP\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic);
    }
}
