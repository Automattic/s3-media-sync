...
use WPCOM_VIP\PhpParser\Internal\DiffElem;
use WPCOM_VIP\PhpParser\Internal\PrintableNewAnonClassNode;
use WPCOM_VIP\PhpParser\Internal\TokenStream;
...
abstract class PrettyPrinterAbstract
{
    ...
    protected $precedenceMap = [
        ...
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Pow::class => [0, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\BitwiseNot::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\PreInc::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\PreDec::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\PostInc::class => [10, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\PostDec::class => [10, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\UnaryPlus::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\UnaryMinus::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Int_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Double::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\String_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Array_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Object_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Bool_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Cast\Unset_::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\ErrorSuppress::class => [10, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Instanceof_::class => [20, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BooleanNot::class => [30, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Mul::class => [40, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Div::class => [40, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Mod::class => [40, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Plus::class => [50, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Minus::class => [50, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Concat::class => [50, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class => [60, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\ShiftRight::class => [60, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Smaller::class => [70, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class => [70, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Greater::class => [70, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class => [70, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Equal::class => [80, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\NotEqual::class => [80, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Identical::class => [80, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\NotIdentical::class => [80, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Spaceship::class => [80, 0],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class => [90, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class => [100, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class => [110, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class => [120, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BooleanOr::class => [130, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Coalesce::class => [140, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Ternary::class => [150, 0],
        // parser uses %left for assignments, but they really behave as %right
        \WPCOM_VIP\PhpParser\Node\Expr\Assign::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignRef::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Plus::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Minus::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Mul::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Div::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Concat::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Mod::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseOr::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseXor::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\ShiftLeft::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\ShiftRight::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Pow::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Coalesce::class => [160, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\YieldFrom::class => [165, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\Print_::class => [168, 1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class => [170, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalXor::class => [180, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalOr::class => [190, -1],
        \WPCOM_VIP\PhpParser\Node\Expr\Include_::class => [200, -1],
    ];
     ...
     */
    public function prettyPrintExpr(\WPCOM_VIP\PhpParser\Node\Expr $node) : string
    {
        $this->resetState();
    ...
    public function prettyPrintFile(array $stmts) : string
    {
        ...
        if ($stmts[0] instanceof \WPCOM_VIP\PhpParser\Node\Stmt\InlineHTML) {
            $p = \preg_replace('/^<\\?php\\s+\\?>\\n?/', '', $p);
        }
        if ($stmts[\count($stmts) - 1] instanceof \WPCOM_VIP\PhpParser\Node\Stmt\InlineHTML) {
    ...
    protected function preprocessNodes(array $nodes)
    {
        ...
        foreach ($nodes as $node) {
            if ($node instanceof \WPCOM_VIP\PhpParser\Node\Stmt\Namespace_ && null === $node->name) {
    ...
    protected function pStmts(array $nodes, bool $indent = \true) : string
    {
        ...
        foreach ($nodes as $node) {
            ...
            if ($comments) {
                ...
                if ($node instanceof \WPCOM_VIP\PhpParser\Node\Stmt\Nop) {
                    continue;
                }
            }
     ...
     */
    protected function pInfixOp(string $class, \WPCOM_VIP\PhpParser\Node $leftNode, string $operatorString, \WPCOM_VIP\PhpParser\Node $rightNode) : string
    {
     ...
     */
    protected function pPrefixOp(string $class, string $operatorString, \WPCOM_VIP\PhpParser\Node $node) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPostfixOp(string $class, \WPCOM_VIP\PhpParser\Node $node, string $operatorString) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPrec(\WPCOM_VIP\PhpParser\Node $node, int $parentPrecedence, int $parentAssociativity, int $childPosition) : string
    {
    ...
    public function printFormatPreserving(array $stmts, array $origStmts, array $origTokens) : string
    {
        ...
        $this->resetState();
        $this->origTokens = new \WPCOM_VIP\PhpParser\Internal\TokenStream($origTokens);
        $this->preprocessNodes($stmts);
        $pos = 0;
    ...
    protected function pFallback(\WPCOM_VIP\PhpParser\Node $node)
    {
     ...
     * @return string Pretty printed node
     */
    protected function p(\WPCOM_VIP\PhpParser\Node $node, $parentFormatPreserved = \false) : string
    {
        ...
        $fallbackNode = $node;
        if ($node instanceof \WPCOM_VIP\PhpParser\Node\Expr\New_ && $node->class instanceof \WPCOM_VIP\PhpParser\Node\Stmt\Class_) {
            // Normalize node structure of anonymous classes
            $node = \WPCOM_VIP\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($node);
            $origNode = \WPCOM_VIP\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($origNode);
        }
        ...
        // printed.
        if ($node instanceof \WPCOM_VIP\PhpParser\Node\Stmt\InlineHTML && !$parentFormatPreserved) {
        ...
        foreach ($node->getSubNodeNames() as $subNodeName) {
            ...
            if (!$subNode instanceof \WPCOM_VIP\PhpParser\Node && $subNode !== null || !$origSubNode instanceof \WPCOM_VIP\PhpParser\Node && $origSubNode !== null) {
    ...
    protected function pArray(array $nodes, array $origNodes, int &$pos, int $indentAdjustment, string $parentNodeType, string $subNodeName, $fixup)
    {
        ...
        foreach ($diff as $i => $diffElem) {
            ...
            if ($diffType === \WPCOM_VIP\PhpParser\Internal\DiffElem::TYPE_KEEP || $diffType === \WPCOM_VIP\PhpParser\Internal\DiffElem::TYPE_REPLACE) {
                ...
                if (!$arrItem instanceof \WPCOM_VIP\PhpParser\Node || !$origArrItem instanceof \WPCOM_VIP\PhpParser\Node) {
                ...
                $skipRemovedNode = \false;
            } elseif ($diffType === \WPCOM_VIP\PhpParser\Internal\DiffElem::TYPE_ADD) {
                if (null === $insertStr) {
            ...
            } elseif ($diffType === \WPCOM_VIP\PhpParser\Internal\DiffElem::TYPE_REMOVE) {
                if (!$origArrItem instanceof \WPCOM_VIP\PhpParser\Node) {
     ...
     */
    protected function pFixup(int $fixup, \WPCOM_VIP\PhpParser\Node $subNode, $parentClass, int $subStartPos, int $subEndPos) : string
    {
        switch ($fixup) {
            ...
            case self::FIXUP_VAR_BRACED_NAME:
                if ($subNode instanceof \WPCOM_VIP\PhpParser\Node\Expr && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return ($fixup === self::FIXUP_VAR_BRACED_NAME ? '$' : '') . '{' . $this->p($subNode) . '}';
                }
                break;
            case self::FIXUP_ENCAPSED:
                if (!$subNode instanceof \WPCOM_VIP\PhpParser\Node\Scalar\EncapsedStringPart && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return '{' . $this->p($subNode) . '}';
                }
                break;
            default:
     ...
     */
    protected function callLhsRequiresParens(\WPCOM_VIP\PhpParser\Node $node) : bool
    {
        return !($node instanceof \WPCOM_VIP\PhpParser\Node\Name || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\Variable || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\ArrayDimFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\FuncCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\MethodCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\NullsafeMethodCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\StaticCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\Array_);
    }
    /**
     ...
     * @return bool Whether parentheses are required
     */
    protected function dereferenceLhsRequiresParens(\WPCOM_VIP\PhpParser\Node $node) : bool
    {
        return !($node instanceof \WPCOM_VIP\PhpParser\Node\Expr\Variable || $node instanceof \WPCOM_VIP\PhpParser\Node\Name || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\ArrayDimFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\PropertyFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\NullsafePropertyFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\StaticPropertyFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\FuncCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\MethodCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\NullsafeMethodCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\StaticCall || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\Array_ || $node instanceof \WPCOM_VIP\PhpParser\Node\Scalar\String_ || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\ConstFetch || $node instanceof \WPCOM_VIP\PhpParser\Node\Expr\ClassConstFetch);
    }
    /**
    ...
    {
        return ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC ? 'public ' : '') . ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_PROTECTED ? 'protected ' : '') . ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_PRIVATE ? 'private ' : '') . ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC ? 'static ' : '') . ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT ? 'abstract ' : '') . ($modifiers & \WPCOM_VIP\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL ? 'final ' : '');
    }
    /**
    ...
    protected function initializeNodeListDiffer()
    {
        ...
        $this->nodeListDiffer = new \WPCOM_VIP\PhpParser\Internal\Differ(function ($a, $b) {
            if ($a instanceof \WPCOM_VIP\PhpParser\Node && $b instanceof \WPCOM_VIP\PhpParser\Node) {
    ...
    protected function initializeFixupMap()
    {
        ...
        $this->fixupMap = [
            \WPCOM_VIP\PhpParser\Node\Expr\PreInc::class => ['var' => self::FIXUP_PREC_RIGHT],
            \WPCOM_VIP\PhpParser\Node\Expr\PreDec::class => ['var' => self::FIXUP_PREC_RIGHT],
            \WPCOM_VIP\PhpParser\Node\Expr\PostInc::class => ['var' => self::FIXUP_PREC_LEFT],
            \WPCOM_VIP\PhpParser\Node\Expr\PostDec::class => ['var' => self::FIXUP_PREC_LEFT],
            \WPCOM_VIP\PhpParser\Node\Expr\Instanceof_::class => ['expr' => self::FIXUP_PREC_LEFT, 'class' => self::FIXUP_PREC_RIGHT],
            \WPCOM_VIP\PhpParser\Node\Expr\Ternary::class => ['cond' => self::FIXUP_PREC_LEFT, 'else' => self::FIXUP_PREC_RIGHT],
            \WPCOM_VIP\PhpParser\Node\Expr\FuncCall::class => ['name' => self::FIXUP_CALL_LHS],
            \WPCOM_VIP\PhpParser\Node\Expr\StaticCall::class => ['class' => self::FIXUP_DEREF_LHS],
            \WPCOM_VIP\PhpParser\Node\Expr\ArrayDimFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \WPCOM_VIP\PhpParser\Node\Expr\ClassConstFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \WPCOM_VIP\PhpParser\Node\Expr\New_::class => ['class' => self::FIXUP_DEREF_LHS],
            // TODO: FIXUP_NEW_VARIABLE
            \WPCOM_VIP\PhpParser\Node\Expr\MethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \WPCOM_VIP\PhpParser\Node\Expr\NullsafeMethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \WPCOM_VIP\PhpParser\Node\Expr\StaticPropertyFetch::class => ['class' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_VAR_BRACED_NAME],
            \WPCOM_VIP\PhpParser\Node\Expr\PropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \WPCOM_VIP\PhpParser\Node\Expr\NullsafePropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \WPCOM_VIP\PhpParser\Node\Scalar\Encapsed::class => ['parts' => self::FIXUP_ENCAPSED],
        ];
        $binaryOps = [\WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Pow::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Mul::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Div::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Mod::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Plus::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Minus::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Concat::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\ShiftRight::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Smaller::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Greater::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Equal::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\NotEqual::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Identical::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\NotIdentical::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Spaceship::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\BooleanOr::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\Coalesce::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalXor::class, \WPCOM_VIP\PhpParser\Node\Expr\BinaryOp\LogicalOr::class];
        foreach ($binaryOps as $binaryOp) {
            $this->fixupMap[$binaryOp] = ['left' => self::FIXUP_PREC_LEFT, 'right' => self::FIXUP_PREC_RIGHT];
        }
        $assignOps = [\WPCOM_VIP\PhpParser\Node\Expr\Assign::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignRef::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Plus::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Minus::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Mul::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Div::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Concat::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Mod::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseOr::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\BitwiseXor::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\ShiftLeft::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\ShiftRight::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Pow::class, \WPCOM_VIP\PhpParser\Node\Expr\AssignOp\Coalesce::class];
        foreach ($assignOps as $assignOp) {
            $this->fixupMap[$assignOp] = ['var' => self::FIXUP_PREC_LEFT, 'expr' => self::FIXUP_PREC_RIGHT];
        }
        $prefixOps = [\WPCOM_VIP\PhpParser\Node\Expr\BitwiseNot::class, \WPCOM_VIP\PhpParser\Node\Expr\BooleanNot::class, \WPCOM_VIP\PhpParser\Node\Expr\UnaryPlus::class, \WPCOM_VIP\PhpParser\Node\Expr\UnaryMinus::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Int_::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Double::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\String_::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Array_::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Object_::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Bool_::class, \WPCOM_VIP\PhpParser\Node\Expr\Cast\Unset_::class, \WPCOM_VIP\PhpParser\Node\Expr\ErrorSuppress::class, \WPCOM_VIP\PhpParser\Node\Expr\YieldFrom::class, \WPCOM_VIP\PhpParser\Node\Expr\Print_::class, \WPCOM_VIP\PhpParser\Node\Expr\Include_::class];
