...
class AstRuntime
{
    ...
    public function __construct(\WPCOM_VIP\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \WPCOM_VIP\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \WPCOM_VIP\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \WPCOM_VIP\JmesPath\Parser();
    }
    /**
