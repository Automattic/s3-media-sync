...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WPCOM_VIP\JmesPath\Lexer();
        $this->parser = new \WPCOM_VIP\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \WPCOM_VIP\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \WPCOM_VIP\JmesPath\Lexer();
    ...
    {
        $parser = new \WPCOM_VIP\JmesPath\Parser();
