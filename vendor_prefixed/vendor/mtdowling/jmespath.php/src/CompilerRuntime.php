...
class CompilerRuntime
{
     ...
     */
    public function __construct($dir = null, \WPCOM_VIP\JmesPath\Parser $parser = null)
    {
        $this->parser = $parser ?: new \WPCOM_VIP\JmesPath\Parser();
        $this->compiler = new \WPCOM_VIP\JmesPath\TreeCompiler();
        ...
        $this->interpreter = new \WPCOM_VIP\JmesPath\TreeInterpreter();
    }
    /**
