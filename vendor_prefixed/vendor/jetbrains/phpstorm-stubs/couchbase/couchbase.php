...
class Bucket
{
    ...
    const PINGSVC_KV = 0x1;
    /** Ping query (N1QL) service. */
    const PINGSVC_N1QL = 0x2;
    /** Ping views (Map/Reduce) service. */
    const PINGSVC_VIEWS = 0x4;
    /** Ping full text search (FTS) service. */
    const PINGSVC_FTS = 0x8;
    private final function __construct()
    {
    }
    /**
 ...
 * @see \Couchbase\Authenticator
 */
class ClassicAuthenticator implements \Couchbase\Authenticator
{
    /**
 ...
 * @see \Couchbase\Authenticator
 */
class PasswordAuthenticator implements \Couchbase\Authenticator
{
    /**
     * Sets username
     *
 ...
 */
class ViewQuery implements \Couchbase\ViewQueryEncodable
{
 ...
 */
class SpatialViewQuery implements \Couchbase\ViewQueryEncodable
{
    private final function __construct()
    {
    }
 ...
 */
class BooleanFieldSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class BooleanSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class ConjunctionSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class DisjunctionSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class DateRangeSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 * inclusiveness of each bound can be configured.
 */
class NumericRangeSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class DocIdSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class MatchAllSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class MatchNoneSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class MatchPhraseSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class MatchSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 * MatchPhraseQuery.
 */
class PhraseSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class RegexpSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class WildcardSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class PrefixSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class QueryStringSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class TermSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 * inclusiveness of each bound can be configured.
 */
class TermRangeSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class GeoDistanceSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 */
class GeoBoundingBoxSearchQuery implements \JsonSerializable, \Couchbase\SearchQueryPart
{
    private final function __construct()
    {
    }
 ...
 * A facet that gives the number of occurrences of the most recurring terms in all hits.
 */
class TermSearchFacet implements \JsonSerializable, \Couchbase\SearchFacet
{
    private final function __construct()
    {
    }
 ...
 */
class DateRangeSearchFacet implements \JsonSerializable, \Couchbase\SearchFacet
{
    private final function __construct()
    {
    }
 ...
 */
class NumericRangeSearchFacet implements \JsonSerializable, \Couchbase\SearchFacet
{
    private final function __construct()
    {
    }
 ...
 * Sort by the document identifier.
 */
class SearchSortId extends \Couchbase\SearchSort implements \JsonSerializable
{
    private function __construct()
    {
    }
 ...
 * Sort by the hit score.
 */
class SearchSortScore extends \Couchbase\SearchSort implements \JsonSerializable
{
    private function __construct()
    {
    }
 ...
 * Sort by a field in the hits.
 */
class SearchSortField extends \Couchbase\SearchSort implements \JsonSerializable
{
 ...
 */
class SearchSortGeoDistance extends \Couchbase\SearchSort implements \JsonSerializable
{
    private function __construct()
    {
    }
