...
use WPCOM_VIP\JetBrains\PhpStorm\Immutable;
/**
...
final class Ev
{
     ...
     *      extension.
     */
    public static final function feedSignal($signum)
    {
    }
    /**
     ...
     *      extension.
     */
    public static final function feedSignalEvent($signum)
    {
    }
    /**
     ...
     */
    public static final function run($flags = self::FLAG_AUTO)
    {
    }
    /**
     ...
     */
    public static final function sleep($seconds)
    {
    }
    /**
     ...
     */
    public static final function stop($how = self::BREAK_ONE)
    {
    }
    /**
 ...
 * Ev is a singleton providing access to the default loop and to some common operations.
 */
\class_alias('WPCOM_VIP\\Ev', 'Ev', \false);
/**
 * Class EvWatcher
 */
 ...
 * Class EvWatcher
 */
\class_alias('WPCOM_VIP\\EvWatcher', 'EvWatcher', \false);
/**
 * Class EvCheck
 *
...
final class EvCheck extends \EvWatcher
{
     ...
     * @return EvCheck
     */
    public static final function createStopped(callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('WPCOM_VIP\\EvCheck', 'EvCheck', \false);
/**
 * Class EvChild
 *
...
final class EvChild extends \EvWatcher
{
     ...
     * @return EvChild
     */
    public static final function createStopped($pid, $trace, callable $callback, $data = null, $priority = 0)
    {
    }
    /**
 ...
 * It is allowed to register EvChild watchers in the default loop only.
 */
\class_alias('WPCOM_VIP\\EvChild', 'EvChild', \false);
/**
 * Class EvEmbed
 *
...
final class EvEmbed extends \EvWatcher
{
     ...
     * @return EvEmbed
     */
    public static final function createStopped(\EvLoop $embed, callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * Used to embed one event loop into another.
 */
\class_alias('WPCOM_VIP\\EvEmbed', 'EvEmbed', \false);
/**
 * Class EvIo
 *
...
final class EvIo extends \EvWatcher
{
     ...
     * @return EvIo
     */
    public static final function createStopped($fd, $events, callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * Always consider using non-blocking mode.
 */
\class_alias('WPCOM_VIP\\EvIo', 'EvIo', \false);
/**
 * Class EvPeriodic
 *
...
final class EvPeriodic extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct($offset, $interval, ?callable $reschedule_cb = null, callable $callback, $data = null, $priority = 0)
    {
    }
    /**
     ...
     * @return EvPeriodic
     */
    public static final function createStopped($offset, $interval, ?callable $reschedule_cb = null, callable $callback, $data = null, $priority = 0)
    {
    }
    /**
     * Configures the watcher
 ...
 * recursively).
 */
\class_alias('WPCOM_VIP\\EvPeriodic', 'EvPeriodic', \false);
/**
 * Class EvPrepare
 *
 * EvPrepare and EvCheck watchers are usually used in pairs. EvPrepare watchers get invoked before the process blocks,
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('WPCOM_VIP\\EvPrepare', 'EvPrepare', \false);
/**
 * Class EvSignal
 *
...
final class EvSignal extends \EvWatcher
{
     ...
     * @return EvSignal
     */
    public static final function createStopped($signum, callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * all the signals can be blocked in an EvCheck watcher and unblocked in a EvPrepare watcher.
 */
\class_alias('WPCOM_VIP\\EvSignal', 'EvSignal', \false);
/**
 * Class EvStat
 *
...
final class EvStat extends \EvWatcher
{
     ...
     * @return EvStat
     */
    public static final function createStopped($path, $interval, callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * notifications, this can be resource-intensive.
 */
\class_alias('WPCOM_VIP\\EvStat', 'EvStat', \false);
/**
 * Class EvTimer
 *
...
final class EvTimer extends \EvWatcher
{
     ...
     * @return EvTimer
     */
    public static final function createStopped($after, $repeat, callable $callback, $data = null, $priority = 0)
    {
    }
}
/**
 ...
 * iteration.
 */
\class_alias('WPCOM_VIP\\EvTimer', 'EvTimer', \false);
/**
 * Class EvIdle
 *
 ...
 * for new events.
 */
\class_alias('WPCOM_VIP\\EvIdle', 'EvIdle', \false);
/**
 * Class EvFork
 *
 ...
 *
 */
\class_alias('WPCOM_VIP\\EvFork', 'EvFork', \false);
/**
 * Class EvLoop
 *
...
final class EvLoop
{
     ...
     * @return EvIo
     */
    public final function io($fd, $events, callable $callback, $data = null, $priority = 0)
    {
    }
    /**
     ...
     * @param float $timeout_interval
     */
    public static function defaultLoop($flags = \Ev::FLAG_AUTO, $data = null, $io_interval = 0.0, $timeout_interval = 0.0)
    {
    }
}
/**
 ...
 * EvLoop::defaultLoop() method.
 */
\class_alias('WPCOM_VIP\\EvLoop', 'EvLoop', \false);
