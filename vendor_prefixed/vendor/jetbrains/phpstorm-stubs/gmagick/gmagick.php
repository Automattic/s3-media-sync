 ...
 * @link https://php.net/manual/en/class.gmagick.php
 */
\class_alias('WPCOM_VIP\\Gmagick', 'Gmagick', \false);
/**
 ...
 * @link https://php.net/manual/en/class.gmagickdraw.php
 */
\class_alias('WPCOM_VIP\\GmagickDraw', 'GmagickDraw', \false);
class GmagickException extends \Exception
{
}
\class_alias('WPCOM_VIP\\GmagickException', 'GmagickException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.gmagickpixel.php
 */
\class_alias('WPCOM_VIP\\GmagickPixel', 'GmagickPixel', \false);
class GmagickPixelException extends \Exception
{
}
\class_alias('WPCOM_VIP\\GmagickPixelException', 'GmagickPixelException', \false);
