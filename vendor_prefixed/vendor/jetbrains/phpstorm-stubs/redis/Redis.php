...
class Redis
{
    ...
    public function open($host, $port = 6379, $timeout = 0.0, $reserved = null, $retryInterval = 0, $readTimeout = 0.0)
    {
    }
    /**
     ...
     * </pre>
     */
    public function pconnect($host, $port = 6379, $timeout = 0.0, $persistentId = null, $retryInterval = 0, $readTimeout = 0.0)
    {
    }
    /**
     * @param string $host
    ...
    public function popen($host, $port = 6379, $timeout = 0.0, $persistentId = '', $retryInterval = 0, $readTimeout = 0.0)
    {
    }
    /**
 ...
 * @link   https://github.com/ukko/phpredis-phpdoc
 */
\class_alias('WPCOM_VIP\\Redis', 'Redis', \false);
class RedisException extends \Exception
{
}
\class_alias('WPCOM_VIP\\RedisException', 'RedisException', \false);
/**
 * @mixin \Redis
 */
class RedisArray
 ...
 * @mixin \Redis
 */
\class_alias('WPCOM_VIP\\RedisArray', 'RedisArray', \false);
