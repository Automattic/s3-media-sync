...
class FFI
{
     ...
     * @throws ParserException
     */
    public static function new($type, bool $owned = \true, bool $persistent = \false) : \FFI\CData
    {
    }
    /**
     ...
     * @return void
     */
    public static function free(\FFI\CData $pointer) : void
    {
    }
    /**
     ...
     * @return CData
     */
    public static function cast($type, \FFI\CData $pointer) : \FFI\CData
    {
    }
    /**
     ...
     * @return CType
     */
    public static function typeof(\FFI\CData $pointer) : \FFI\CType
    {
    }
    /**
     ...
     * @return CData
     */
    public static function addr(\FFI\CData $pointer) : \FFI\CData
    {
    }
    /**
     ...
     * @param int $size
     */
    public static function memcpy(\FFI\CData $target, &$source, int $size) : void
    {
    }
    /**
     ...
     * @param int $size
     */
    public static function memset(\FFI\CData $target, int $byte, int $size) : void
    {
    }
    /**
     ...
     * @return string
     */
    public static function string(\FFI\CData $source, int $size = 0) : string
    {
    }
    /**
 ...
 * @since 7.4
 */
\class_alias('WPCOM_VIP\\FFI', 'FFI', \false);
namespace WPCOM_VIP\FFI;
 ...
 * @since 7.4
 */
class ParserException extends \FFI\Exception
{
}
/**
 * Class CData
