...
// Start of Zend Extensions
\class_alias('WPCOM_VIP\\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('WPCOM_VIP\\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('WPCOM_VIP\\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('WPCOM_VIP\\JavaException', 'JavaException', \false);
