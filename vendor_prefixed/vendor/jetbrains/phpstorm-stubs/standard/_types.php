 ...
 * @link https://wiki.php.net/rfc/generators
 */
\class_alias('WPCOM_VIP\\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('WPCOM_VIP\\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace WPCOM_VIP\___PHPSTORM_HELPERS;
