...
class ChannelCredentials
{
     ...
     * @throws \InvalidArgumentException
     */
    public static function createComposite(\Grpc\ChannelCredentials $cred1, \Grpc\CallCredentials $cred2)
    {
    }
    /**
...
class Call
{
     ...
     * @throws \InvalidArgumentException
     */
    public function __construct(\Grpc\Channel $channel, $method, \Grpc\Timeval $absolute_deadline, $host_override = null)
    {
    }
    /**
...
class CallCredentials
{
     ...
     * @throws \InvalidArgumentException
     */
    public static function createComposite(\Grpc\CallCredentials $cred1, \Grpc\CallCredentials $cred2)
    {
    }
    /**
...
class Timeval
{
     ...
     * @throws \InvalidArgumentException
     */
    public function add(\Grpc\Timeval $other)
    {
    }
    /**
     ...
     * @throws \InvalidArgumentException
     */
    public static function compare(\Grpc\Timeval $a, \Grpc\Timeval $b)
    {
    }
    /**
     ...
     * @throws \InvalidArgumentException
     */
    public static function similar(\Grpc\Timeval $a, \Grpc\Timeval $b, \Grpc\Timeval $threshold)
    {
    }
    /**
     ...
     * @throws \InvalidArgumentException
     */
    public function subtract(\Grpc\Timeval $other)
    {
    }
    /**
