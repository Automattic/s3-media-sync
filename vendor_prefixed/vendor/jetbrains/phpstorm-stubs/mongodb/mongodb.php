 ...
 */
namespace WPCOM_VIP\MongoDB;

namespace WPCOM_VIP\MongoDB\Driver;
...
final class Manager
{
     ...
     */
    public final function __construct($uri, array $uriOptions = [], array $driverOptions = [])
    {
    }
    /**
     ...
     */
    public final function executeBulkWrite($namespace, \MongoDB\Driver\BulkWrite $bulk, $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0 added $options argument
     */
    public final function executeCommand($db, \MongoDB\Driver\Command $command, $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0 added $options argument
     */
    public final function executeQuery($namespace, \MongoDB\Driver\Query $query, $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadCommand($db, \MongoDB\Driver\Command $command, array $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadWriteCommand($db, \MongoDB\Driver\Command $command, array $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeWriteCommand($db, \MongoDB\Driver\Command $command, array $options = [])
    {
    }
    /**
     ...
     * @return Server
     */
    public final function selectServer(\MongoDB\Driver\ReadPreference $readPreference = null)
    {
    }
    /**
...
final class Server
{
     ...
     * @since 1.0.0
     */
    public final function executeBulkWrite($namespace, \MongoDB\Driver\BulkWrite $zwrite, $options = [])
    {
    }
    /**
     ...
     * @since 1.0.0
     */
    public final function executeCommand($db, \MongoDB\Driver\Command $command, \MongoDB\Driver\ReadPreference $readPreference = null)
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadCommand($db, \MongoDB\Driver\Command $command, array $option = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadWriteCommand($db, \MongoDB\Driver\Command $command, array $option = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeWriteCommand($db, \MongoDB\Driver\Command $command, array $option = [])
    {
    }
    /**
     ...
     * @return Cursor
     */
    public final function executeQuery($namespace, \MongoDB\Driver\Query $query, $option = [])
    {
    }
    /**
...
final class Query
{
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function __construct($filter, array $queryOptions = [])
    {
    }
}
/**
...
final class Command
{
     ...
     * @since 1.0.0
     */
    public final function __construct($document, array $commandOptions = [])
    {
    }
}
/**
...
final class ReadPreference implements \MongoDB\BSON\Serializable, \Serializable
{
     ...
     */
    public final function __construct(string|int $mode, array $tagSets = null, array $options = [])
    {
    }
    /**
...
final class Session
{
     ...
     * @since 1.4.0
     */
    public final function advanceOperationTime(\MongoDB\BSON\TimestampInterface $operationTime)
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function startTransaction($options)
    {
    }
}
/**
...
final class ClientEncryption
{
     ...
     */
    public final function createDataKey($kmsProvider, $options = [])
    {
    }
    /**
     ...
     */
    public final function decrypt(\MongoDB\BSON\Binary $value)
    {
    }
    /**
     ...
     */
    public final function encrypt($value, $options = [])
    {
    }
}
namespace WPCOM_VIP\MongoDB\Driver\Exception;
...
class RuntimeException extends \RuntimeException implements \MongoDB\Driver\Exception\Exception
{
     ...
     * @return bool
     */
    public final function hasErrorLabel($errorLabel)
    {
    }
}
/**
...
class WriteConcernException extends \MongoDB\Driver\Exception\RuntimeException implements \MongoDB\Driver\Exception\Exception
{
}
/**
 ...
 */
namespace WPCOM_VIP\MongoDB\Driver\Monitoring;
 ...
 */
namespace WPCOM_VIP\MongoDB\BSON;
 ...
 */
final class Binary implements \MongoDB\BSON\Type, \MongoDB\BSON\BinaryInterface, \Serializable, \JsonSerializable
{
 ...
 */
final class Decimal128 implements \MongoDB\BSON\Type, \MongoDB\BSON\Decimal128Interface, \Serializable, \JsonSerializable
{
    /**
 ...
 */
final class Javascript implements \MongoDB\BSON\Type, \MongoDB\BSON\JavascriptInterface, \Serializable, \JsonSerializable
{
    /**
     ...
     */
    public final function __construct($code, $scope = [])
    {
    }
    public static function __set_state($an_array)
    {
 ...
 */
final class MaxKey implements \MongoDB\BSON\Type, \MongoDB\BSON\MaxKeyInterface, \Serializable, \JsonSerializable
{
    public static function __set_state($an_array)
    {
    }
 ...
 */
final class MinKey implements \MongoDB\BSON\Type, \MongoDB\BSON\MinKeyInterface, \Serializable, \JsonSerializable
{
    public static function __set_state($an_array)
    {
    }
 ...
 */
final class ObjectId implements \MongoDB\BSON\Type, \MongoDB\BSON\ObjectIdInterface, \Serializable, \JsonSerializable
{
    /**
 ...
 */
final class Regex implements \MongoDB\BSON\Type, \MongoDB\BSON\RegexInterface, \Serializable, \JsonSerializable
{
    /**
 ...
 */
final class UTCDateTime implements \MongoDB\BSON\Type, \MongoDB\BSON\UTCDateTimeInterface, \Serializable, \JsonSerializable
{
    /**
 ...
 */
interface Unserializable extends \MongoDB\BSON\Type
{
    /**
