...
\class_alias('WPCOM_VIP\\HttpException', 'HttpException', \false);
class HttpRuntimeException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpRuntimeException', 'HttpRuntimeException', \false);
class HttpInvalidParamException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpInvalidParamException', 'HttpInvalidParamException', \false);
class HttpHeaderException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpHeaderException', 'HttpHeaderException', \false);
class HttpMalformedHeadersException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpMalformedHeadersException', 'HttpMalformedHeadersException', \false);
class HttpRequestMethodException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpRequestMethodException', 'HttpRequestMethodException', \false);
class HttpMessageTypeException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpMessageTypeException', 'HttpMessageTypeException', \false);
class HttpEncodingException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpEncodingException', 'HttpEncodingException', \false);
class HttpRequestException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpRequestException', 'HttpRequestException', \false);
class HttpRequestPoolException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpRequestPoolException', 'HttpRequestPoolException', \false);
class HttpSocketException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpSocketException', 'HttpSocketException', \false);
class HttpResponseException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpResponseException', 'HttpResponseException', \false);
class HttpUrlException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpUrlException', 'HttpUrlException', \false);
class HttpQueryStringException extends \HttpException
{
}
\class_alias('WPCOM_VIP\\HttpQueryStringException', 'HttpQueryStringException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpdeflatestream.php
 */
\class_alias('WPCOM_VIP\\HttpDeflateStream', 'HttpDeflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpinflatestream.php
 */
\class_alias('WPCOM_VIP\\HttpInflateStream', 'HttpInflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpmessage.php
 */
\class_alias('WPCOM_VIP\\HttpMessage', 'HttpMessage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpquerystring.php
 */
\class_alias('WPCOM_VIP\\HttpQueryString', 'HttpQueryString', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequest.php
 */
\class_alias('WPCOM_VIP\\HttpRequest', 'HttpRequest', \false);
...
\class_alias('WPCOM_VIP\\HttpRequestDataShare', 'HttpRequestDataShare', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequestpool.php
 */
\class_alias('WPCOM_VIP\\HttpRequestPool', 'HttpRequestPool', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpresponse.php
 */
\class_alias('WPCOM_VIP\\HttpResponse', 'HttpResponse', \false);
class HttpUtil
{
    /**
...
\class_alias('WPCOM_VIP\\HttpUtil', 'HttpUtil', \false);
/**
