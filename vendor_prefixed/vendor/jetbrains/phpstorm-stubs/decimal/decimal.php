...
final class Decimal implements \JsonSerializable
{
     ...
     */
    public function __construct($value, int $precision = \Decimal\Decimal::DEFAULT_PRECISION)
    {
    }
    /**
     * Sum
     ...
     */
    public static function sum($values, int $precision = \Decimal\Decimal::DEFAULT_PRECISION) : \Decimal\Decimal
    {
    }
    /**
     * Average
     ...
     * @throws \ArithmeticError if addition is undefined, eg. INF + -INF
     */
    public static function avg($values, int $precision = \Decimal\Decimal::DEFAULT_PRECISION) : \Decimal\Decimal
    {
    }
    /**
     * Copy
     ...
     */
    public function copy(?int $precision = null) : \Decimal\Decimal
    {
    }
    /**
     * Add
     ...
     * @throws \TypeError if the value is not a decimal, string or integer.
     */
    public function add($value) : \Decimal\Decimal
    {
    }
    /**
     * Subtract
     ...
     * @throws \TypeError if the value is not a decimal, string or integer.
     */
    public function sub($value) : \Decimal\Decimal
    {
    }
    /**
     * Multiply
     ...
     */
    public function mul($value) : \Decimal\Decimal
    {
    }
    /**
     * Divide
     ...
     */
    public function div($value) : \Decimal\Decimal
    {
    }
    /**
     * Modulo (integer)
     ...
     */
    public function mod($value) : \Decimal\Decimal
    {
    }
    /**
     * Remainder
     ...
     * @throws \ArithmeticError if the operation is undefined, eg. INF, -INF
     */
    public function rem($value) : \Decimal\Decimal
    {
    }
    /**
     * Power
     ...
     */
    public function pow($exponent) : \Decimal\Decimal
    {
    }
    /**
     * Natural logarithm
     ...
     */
    public function ln() : \Decimal\Decimal
    {
    }
    /**
     * Exponent
     ...
     *                 with the same precision as this decimal.
     */
    public function exp() : \Decimal\Decimal
    {
    }
    /**
     * Base-10 logarithm
     ...
     */
    public function log10() : \Decimal\Decimal
    {
    }
    /**
     * Square root
     ...
     *                 as this decimal.
     */
    public function sqrt() : \Decimal\Decimal
    {
    }
    /**
     * Floor
     ...
     */
    public function floor() : \Decimal\Decimal
    {
    }
    /**
     * Ceiling
     ...
     */
    public function ceil() : \Decimal\Decimal
    {
    }
    /**
     * Truncate
     ...
     */
    public function truncate() : \Decimal\Decimal
    {
    }
    /**
     * Round
     ...
     */
    public function round(int $places = 0, int $mode = \Decimal\Decimal::DEFAULT_ROUNDING) : \Decimal\Decimal
    {
    }
    /**
     * Decimal point shift.
     ...
     */
    public function shift(int $places) : \Decimal\Decimal
    {
    }
    /**
     ...
     */
    public function trim() : \Decimal\Decimal
    {
    }
    /**
     * Precision
     ...
     */
    public function abs() : \Decimal\Decimal
    {
    }
    /**
     * Negate
     ...
     */
    public function negate() : \Decimal\Decimal
    {
    }
    /**
     ...
     */
    public function toFixed(int $places = 0, bool $commas = \false, int $rounding = \Decimal\Decimal::DEFAULT_ROUNDING) : string
    {
    }
    /**
