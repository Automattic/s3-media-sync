 ...
 * created using:
 */
\class_alias('WPCOM_VIP\\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('WPCOM_VIP\\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('WPCOM_VIP\\colorObj', 'colorObj', \false);
...
\class_alias('WPCOM_VIP\\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('WPCOM_VIP\\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('WPCOM_VIP\\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('WPCOM_VIP\\imageObj', 'imageObj', \false);
...
\class_alias('WPCOM_VIP\\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('WPCOM_VIP\\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('WPCOM_VIP\\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('WPCOM_VIP\\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('WPCOM_VIP\\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('WPCOM_VIP\\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
     ...
     * @return int
     */
    public final function appendOutputFormat(\WPCOM_VIP\outputFormatObj $outputFormat)
    {
    }
    /**
...
\class_alias('WPCOM_VIP\\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('WPCOM_VIP\\outputformatObj', 'outputformatObj', \false);
...
\class_alias('WPCOM_VIP\\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('WPCOM_VIP\\pointObj', 'pointObj', \false);
...
\class_alias('WPCOM_VIP\\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('WPCOM_VIP\\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('WPCOM_VIP\\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('WPCOM_VIP\\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('WPCOM_VIP\\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('WPCOM_VIP\\scalebarObj', 'scalebarObj', \false);
...
\class_alias('WPCOM_VIP\\shapefileObj', 'shapefileObj', \false);
...
\class_alias('WPCOM_VIP\\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('WPCOM_VIP\\styleObj', 'styleObj', \false);
...
\class_alias('WPCOM_VIP\\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('WPCOM_VIP\\webObj', 'webObj', \false);
