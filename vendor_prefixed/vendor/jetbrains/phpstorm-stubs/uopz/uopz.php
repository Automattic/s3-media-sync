 ...
 */
function uopz_add_function(string $class, string $function, \Closure $handler, int $flags = \ZEND_ACC_PUBLIC, bool $all = \true) : bool
{
}
/**
 ...
 */
function uopz_del_function(string $class, string $function, bool $all = \true) : bool
{
}
/**
