 ...
 * @link https://docs.datastax.com/en/developer/php-driver/latest/api/class.Cassandra/
 */
\class_alias('WPCOM_VIP\\Cassandra', 'Cassandra', \false);
/**
 * @link https://docs.datastax.com/en/developer/php-driver/latest/api/Cassandra/
 */
namespace WPCOM_VIP\Cassandra;
 ...
 */
final class DefaultCluster implements \Cassandra\Cluster
{
    /**
     * Creates a new Session instance.
     *
 ...
 */
final class SimpleStatement implements \Cassandra\Statement
{
    /**
 ...
 */
final class Tuple implements \Cassandra\Value, \Countable, \Iterator
{
    /**
 ...
 */
final class Smallint implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
 ...
 */
final class FuturePreparedStatement implements \Cassandra\Future
{
    /**
     * Waits for a given future resource to resolve and throws errors if any.
     *
 ...
 */
final class BatchStatement implements \Cassandra\Statement
{
    /**
 ...
 */
final class Collection implements \Cassandra\Value, \Countable, \Iterator
{
    /**
 ...
 */
final class FutureRows implements \Cassandra\Future
{
    /**
     * Waits for a given future resource to resolve and throws errors if any.
     *
 ...
 */
final class Bigint implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
 ...
 */
final class Set implements \Cassandra\Value, \Countable, \Iterator
{
    /**
     * Creates a new collection of a given type.
     *
 ...
 */
final class Timestamp implements \Cassandra\Value
{
    /**
 ...
 */
final class Tinyint implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
 ...
 */
final class Timeuuid implements \Cassandra\Value, \Cassandra\UuidInterface
{
    /**
 ...
 */
final class DefaultSession implements \Cassandra\Session
{
    /**
     * Execute a query.
     *
 ...
 */
abstract class Custom implements \Cassandra\Value
{
    /**
 ...
 */
final class Time implements \Cassandra\Value
{
    /**
 ...
 */
final class Varint implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
 ...
 */
final class Map implements \Cassandra\Value, \Countable, \Iterator, \ArrayAccess
{
    /**
 ...
 */
final class Uuid implements \Cassandra\Value, \Cassandra\UuidInterface
{
    /**
 ...
 */
final class Float_ implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
     * Creates a new float.
     *
 ...
 */
final class Duration implements \Cassandra\Value
{
    /**
 ...
 */
final class Inet implements \Cassandra\Value
{
    /**
 ...
 */
final class Date implements \Cassandra\Value
{
    /**
 ...
 */
final class Blob implements \Cassandra\Value
{
    /**
 ...
 */
final class FutureValue implements \Cassandra\Future
{
    /**
     * Waits for a given future resource to resolve and throws errors if any.
     *
 ...
 */
final class Decimal implements \Cassandra\Value, \Cassandra\Numeric
{
    /**
 ...
 */
final class FutureClose implements \Cassandra\Future
{
    /**
     * Waits for a given future resource to resolve and throws errors if any.
     *
 ...
 */
final class PreparedStatement implements \Cassandra\Statement
{
 ...
 */
final class UserTypeValue implements \Cassandra\Value, \Countable, \Iterator
{
    /**
 ...
 */
namespace WPCOM_VIP\Cassandra\Cluster;
 ...
 */
namespace WPCOM_VIP\Cassandra\TimestampGenerator;
 ...
 */
namespace WPCOM_VIP\Cassandra\RetryPolicy;
 ...
 */
namespace WPCOM_VIP\Cassandra\Type;
 ...
 */
namespace WPCOM_VIP\Cassandra\SSLOptions;
 ...
 */
namespace WPCOM_VIP\Cassandra\Exception;
