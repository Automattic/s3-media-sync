 ...
 */
abstract class OutputStyle implements \WPCOM_VIP\Symfony\Component\Console\Output\OutputInterface, \WPCOM_VIP\Symfony\Component\Console\Style\StyleInterface
{
    private $output;
    ...
    {
        return new \WPCOM_VIP\Symfony\Component\Console\Helper\ProgressBar($this->output, $max);
    }
    /**
     * {@inheritdoc}
     */
