 ...
 */
class ConsoleSectionOutput extends \WPCOM_VIP\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, int $verbosity, bool $decorated, \WPCOM_VIP\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
    ...
    {
        return \WPCOM_VIP\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->getFormatter(), \str_replace("\t", '        ', $text));
    }
}
